/*
*  password_has_been_reset_widget.dart
*  Loci2  Flutter
*
*  Created by Kaya.
...
class PasswordHasBeenResetWidget extends StatelessWidget {
  
  void onRectangle132Pressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => ProfileWidget()));
          ...
          children: [
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      height: 56,
                      child: Image.asset(
                        "assets/images/ellipse-2-23.png",
                        fit: BoxFit.none,
                      ),
                    ),
                  ),
            ...
            Align(
              ...
              child: Container(
                width: 333,
                height: 48,
                margin: EdgeInsets.only(top: 106, right: 33),
                child: Stack(
                  alignment: Alignment.center,
                  children: [
                    Positioned(
