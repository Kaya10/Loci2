...
class JoinedGamesWidget extends StatelessWidget {
  ...
  void onContinueFourPressed(BuildContext context) {
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    height: 56,
                    margin: EdgeInsets.only(left: 30, top: 30, right: 28),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Align(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 263,
                      height: 48,
                      margin: EdgeInsets.only(top: 38, right: 68),
                      child: FlatButton(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 265,
                      height: 48,
                      margin: EdgeInsets.only(top: 29, right: 67),
                      child: Stack(
                        alignment: Alignment.center,
                        children: [
                          Positioned(
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 267,
                      height: 48,
                      margin: EdgeInsets.only(top: 29, right: 66),
                      child: FlatButton(
                  ...
                  Container(
                    height: 45,
                    margin: EdgeInsets.only(left: 58, top: 27, right: 55),
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Align(
                          ...
                          Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 45,
                                  margin: EdgeInsets.only(left: 58, right: 55),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
                                      Align(
                                ...
                                Container(
                                  height: 45,
                                  margin: EdgeInsets.only(left: 58, right: 55, bottom: 53),
                                  child: Row(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
                                      Align(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 45,
                      height: 45,
                      margin: EdgeInsets.only(top: 349),
                      child: Image.asset(
